...
{
	for (const auto Element : DefaultAttributes)
	{
		ApplyEffectToSelf(Element, 1.f);
	}
}

void AAuraCharacterBase::ApplyEffectToSelf(const TSubclassOf<UGameplayEffect> GameplayEffect, const int Level) const
{
